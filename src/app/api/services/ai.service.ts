...
export class AIService {
  ...
  async processChat(
    ...
    // Define tools for todo operations (Vercel-compatible version)
    const tools = [
      {
  ...
  private async executeToolCall(
    toolCall: any, // Using 'any' for simplicity since we're adapting from MCPToolCall
    userId: string,
    conversationId: string
  ): Promise<{ todos?: Todo[] }> {
   ...
   */
  private generateDefaultResponseFromToolCalls(toolCalls: any[]): string {
